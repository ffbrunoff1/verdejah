  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[url(data:image/svg+xml,%3Csvg%20width='20'%20height='20'%20xmlns='http://www.w3.org/2000/svg'%3E%3Cdefs%3E%3Cpattern%20id='grid'%20width='20'%20height='20'%20patternUnits='userSpaceOnUse'%3E%3Cpath%20d='M%2020%200%20L%200%200%200%2020'%20fill='none'%20stroke='%2300ffff'%20stroke-width='0.5'%20opacity='0.1'/%3E%3C/pattern%3E%3C/defs%3E%3Crect%20width='100%25'%20height='100%25'%20fill='url(%23grid)'%20/%3E%3C/svg%3E)] opacity-30"></div>
      </div>
